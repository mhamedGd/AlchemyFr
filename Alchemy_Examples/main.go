...
func main() {
	...
	game := alchemy.App{
		...
		OnStart: func() {
			...
			fontAtlas = alchemy.LoadFontToAtlas("Assets/Alfont.otf", &font_settings)
		...
		OnDraw: func() {
			...
			for i := 0; i < 1; i++ {
				...
				fontAtlas.DrawString("بغداد جيم لاب", alchemy.Vector2fOne.AddXY(0.0, -25.0), 0.5, alchemy.WHITE)
			}
