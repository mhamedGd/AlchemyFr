...
var inputs_map map[string]AlchemyInput

var current_frame_pressed_inputs map[string]AlchemyInput
var prev_frame_pressed_inputs map[string]AlchemyInput
...
func InitInputs() {
	inputs_map = make(map[string]AlchemyInput)

	current_frame_pressed_inputs = make(map[string]AlchemyInput)
	prev_frame_pressed_inputs = make(map[string]AlchemyInput)
}
...
func BindInput(_input_name string, _corr_key KeyCode) {
	...
	inputs_map[_input_name] = AlchemyInput{
		Name:             _input_name,
