...
type AlchemyEvent[T any] struct {
	listeners []EventFunc[T]
}

func (e *AlchemyEvent[T]) AddListener(ef EventFunc[T]) {
	e.listeners = append(e.listeners, ef)
}

func (e *AlchemyEvent[T]) RemoveListener(ef EventFunc[T]) {
...
func (e *AlchemyEvent[T]) Invoke(x ...T) {
